...
<div class="menu-comida">
    ...
    <div class="seccion1">
        ...
        <div class="imagenes">
            <img src="https://img.freepik.com/fotos-premium/ensalada-aislado-sobre-fondo-blanco_87394-17796.jpg" alt="" class="img">
            <img src="https://img.freepik.com/fotos-premium/plato-caldo-aislado-sobre-fondo-blanco_185193-73905.jpg" alt="" class="img">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSlvHcZE_BIowOS3chPG6VjDqD4mquai8ArPP1O_r5-Sw&s" alt="" class="img">
        </div>
    </div>
    <hr>
    <?php
        ...
        <div class="menu-platillo1">
            ...
            <div class="platillos">
                <ul class="list">
                    ...
                    <li>Pechuga azada</li>
                    <li>Bisteck azado</li>
                    <li>Filete pescado asado</li>
                    <li>Filete pescado empanizado</li>
                </ul>
