...
<div class="container">
    <div class="container-fluid">    <h1 class="text-center">Formulario de Registro</h1>
        ...
        <div class="col-md-12" style="z-index: -9999;">
            <form action="validacionesPed.php" method="GET">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" class="form-control" id="telefono" name="telefono" placeholder="Ingresa el número telefónico" required>
                </div>
                <?php 
